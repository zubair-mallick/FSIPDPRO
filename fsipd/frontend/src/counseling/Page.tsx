    ...
    <main className="max-w-6xl mx-3 md:mx-auto section">
      ...
      <header className="mb-8 text-center">
        ...
        <p className="mt-4 text-lg text-gray-400">
          Explore our Councelling Tools designed to give u resource and alert you about available exams and scholarships  you through your
          learning journey, tools include Career Guidance and Resource Finder.
        </p>
